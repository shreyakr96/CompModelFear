...
final_fear_ext = execute_training_trial(1, 2, aversive_present = False, appetitive_present = False, engram_index = None,time_between_trials = 180)
...
plt.plot(trial_and_fear_np_array[:, 0], trial_and_fear_np_array[:, 1], label='Context 2: Acquisition Fear Levels', marker='o')

# Plot extinction trials with adjusted trial numbers
plt.plot(trial_and_fear_ext_np_array[:, 0], trial_and_fear_ext_np_array[:, 1], label='Context 3: Extinction Fear Levels', marker='x')
...
plt.plot(trial_and_fear_ext_np_array[:, 0], trial_and_fear_ext_np_array[:, 1], label='Context 2: Extinction Fear Levels', marker='x')
...
plt.plot(trial_and_fear_cc_np_array[:, 0], trial_and_fear_cc_np_array[:, 1], label='Context 3: Counterconditioning Fear Levels', marker='x')
